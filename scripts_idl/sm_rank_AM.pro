...
;08/18/17 plotting ranks for FLDAS output summary

;;moved standarized SM anomalies to the bottom
...
fname = data_dir+STRING('FLDAS_NOAH01_C_WA_M.A',startyr,startmo,'.001.nc',f='(a,I4.4,I2.2,a)')
...
for i=0,nmos-1 do begin &$
   ...
   ;data_dir = '/home/ftp_out/people/mcnally/FLDAS/FLDAS4DISC/NOAH_CHIRPSv2.001_MERRA2_EA/'
   fnames = FILE_SEARCH(data_dir,STRING('FLDAS_NOAH01_C_WA_M.A????',moi,'.001.nc',f='(a,I2.2,a)')) &$
...
;;can i add in the prelim estimate here? see esp_sm_rank.pro
...
grtitle = TEXT(0.5,0.955,'July (10-40cm) Soil Moisture Rank 2017 ', ALIGNMENT=0.5,FONT_SIZE=16)
...
grtitle = TEXT(0.5,0.955,'Jan-July Soil Moisture (0-10cm) Rank 2017', ALIGNMENT=0.5,FONT_SIZE=16)
